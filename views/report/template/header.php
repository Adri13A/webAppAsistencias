        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent" style="border-radius: 10px;">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    -->
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="../admin/index.php"><i class="fa-solid fa-house"></i> Inicio &nbsp;&nbsp;|</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../admin/readAsistencias.php"><i class="fa-solid fa-calendar-check"></i> Ver asistencias &nbsp;&nbsp;|</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../admin/readAllUsuarios.php"><i class="fa-solid fa-address-book"></i> Usuarios &nbsp;&nbsp;|</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="reporteAsistencias.php"><i class="fa-solid fa-file-lines"></i> Reportes &nbsp;&nbsp;|</a>
                    </li>
