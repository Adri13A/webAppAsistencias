...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-signin w-100 m-auto">
        <div class="card pb-5 pt-5F" style="border-radius: 15px; height: auto; width: auto; position: relative; border: 2px solid black">
            <div class="card-body ">
                <form method="POST" action="./views/usuario/autenticarUsuario.php">
                    ...
                    <h1 class="h3 mb-3 fw-normal"><b>Bienvenido...<i class="fa-solid fa-hand-peace"></i></b></h1>
                    ...
                    <button class="btn btn-warning w-100 py-2" type="submit"><b><i class="fa-solid fa-door-closed"></i> Iniciar Sesion</b></button>
                    <a href="signUp.php" style="color: white;">Registro</a>
                </form>
            </div>
        </div>
    </main>
